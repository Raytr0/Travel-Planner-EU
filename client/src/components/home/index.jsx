...
function Home() {
    ...
    // Safely handle when currentUser is null or undefined
    if (!currentUser) {
        ...
        <div className="container mx-auto pt-14">
            <div className="grid items-start grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="text-2xl font-bold pt-14 ml-3">
                    ...
                    <div className="mt-6">
                        {displayDestinations().map((dest) => (
                            <div key={dest.DestID} className="border p-4 mb-4">
                                <h3 className="text-xl font-bold cursor-pointer" onClick={() => toggleDetails(dest.DestID)}>{dest.Destination}</h3>
                                <p><strong>Country:</strong> {dest.Country}</p>
                                <p><strong>Region:</strong> {dest.Region}</p>
                                {expandedDestinations[dest.DestID] && (
                                    <div className="mt-4">
